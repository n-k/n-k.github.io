...
import { h, createContext, render } from 'https://esm.sh/preact';
import { useState, useContext, useEffect } from 'https://esm.sh/preact/hooks';
...
function App() {
    ...
    // Update UI state when configuration changes
    useEffect(() => {
    ...
    return html`
        ...
        <div class="modal ${showSettings ? '' : 'hidden'}" onClick=${(e) => e.target.classList.contains('modal') && setShowSettings(false)}>
            <div class="modal-content">
                <div class="modal-header">
                    <h2>Settings</h2>
                    <span class="close" onClick=${() => setShowSettings(false)}>&times;</span>
                </div>
